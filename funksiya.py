#function                                      # def - funksiya yaratish kalit so'zi

# def salom_ber(ism):
#     """Bu funksiya foydalanuvchiga salom beradi."""                                          # bu faqat izoh
#     print(f"Assalomu Alaykum! {ism.title()}")                                              # funksiyaning vazifasi
# salom_ber(ism="Ali")                                                                         # funksiyani chaqirish
...
# yosh_hisobla("Muslihiddin", 2008)               # yoki        yosh_hisobla(ism="Muslihiddin", tugilgan_yil=2008)
